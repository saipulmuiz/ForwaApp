...
/* --- Url --- */
const val BASE_URL = "http://192.168.0.102/workspace/fppw/api/"
...
/* --- SharedPreferences --- */
const val SP_NAME = "forwaapp_shared_preferences"
const val SP_KEY_REMINDER = "shared_preferences_reminder"


/* --- Database --- */
// const val DATABASE_NAME = "ForwaappDB.db"
// const val DATABASE_AUTHORITY = "id.saipulmuiz.forwaapp"
